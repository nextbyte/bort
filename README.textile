...
I've applied web app theme to the application and all views were updated to feet the look and feel.
...
A default menu is created also a separate menu for admins. Added 2 helpers to fit web app theme navigation style ( tabs + secondary navigation ). Added one line to plugin's core lib to add first to css class.
